// compile with
// g++ -Wall -pedantic -O3 aufgabe2_test.cpp aufgabe2.cpp -o aufgabe2_test
//
#include <iostream>
#include <string>
#include <algorithm>
...
int main()
{
    ...
    std::cout << "(if code is correctly pushed into Git and aufgabe2_main.cpp is correct as well)\n";
